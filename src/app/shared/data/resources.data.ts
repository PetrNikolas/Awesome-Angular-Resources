...
export const RESOURCES: Resource[] = [
  ...
  },
  {
    ...
    description: 'Build, test, and document your Angular components in isolation',
    link: 'https://storybook.js.org/docs/angular/get-started/introduction',
    type: 'tool',
  },
  {
    id: 52,
  ...
  {
    id: 53,
    title: 'Cypress for Angular',
    description: 'End-to-end testing framework with excellent Angular support',
